...
namespace MakineData.Migrations
{
    ...
    [Migration("20230814070737_mig_20")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MakineEntity.Entities.RoutineMaintenanceDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("RoutineMaintenanceDetailId")
                        .HasColumnType("int");

                    b.Property<int>("RoutineMaintenanceDetailsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RoutineMaintenanceDetailId");
            ...
            modelBuilder.Entity("MakineEntity.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "aba15323-bb34-4688-83a6-1e7b988d42b7",
                            Name = "Superadmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "b89fd853-b43d-4f00-923b-b1b5f522ad14",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "5733daf7-ce86-417f-873e-86b5da6f08cf",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("MakineEntity.Entities.RoutineMaintenanceDetails", b =>
                {
                    ...
                    b.HasOne("MakineEntity.Entities.RoutineMaintenanceDetails", "RoutineMaintenanceDetail")
                        .WithMany()
                        .HasForeignKey("RoutineMaintenanceDetailId");

                    b.Navigation("Asset");

                    b.Navigation("RoutineMaintenanceDetail");
                });

            modelBuilder.Entity("MakineEntity.Entities.Warnings", b =>
                {
                    b.HasOne("MakineEntity.Entities.RoutineMaintenanceDetails", "RoutineMaintenance")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MakineEntity.Entities.AppUser", null)
                        .WithMany()
